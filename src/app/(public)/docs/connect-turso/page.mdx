...
export const metadata = {
  title: "Connect to Turso using Inner Ring Studio - The Best GUI Client for Turso",
};

<DocContent title="Connect to Turso" group="Connecting">

Inner Ring Studio is an excellent GUI for working with the Turso database. Here is
