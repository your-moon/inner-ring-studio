...
Inner Ring Studio is a powerful SQLite client that you can now embed
...
- Instant access to Inner Ring Studio updates

## Embed Inner Ring Studio

You can embed Inner Ring Studio as the following
