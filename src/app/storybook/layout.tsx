        ...
        <div className="bg-surface-canvas flex h-screen w-screen overflow-hidden">
          <aside className="bg-sidebar hidden w-[260px] shrink-0 flex-col overflow-y-auto border-r border-border-subtle md:flex">
            ...
            <SidebarMenuItem
              icon={Layers2}
              text="Layout"
              href="/storybook/layout-primitives"
            />
            <SidebarMenuItem
              icon={Layers2}
              text="Feedback"
              href="/storybook/feedback"
            />
            <SidebarMenuItem
              icon={Layers2}
              text="Overlays"
            ...
            <SidebarMenuItem
              icon={Layers2}
              text="Linear nav & command"
              href="/storybook/linear-shell"
            />
            <SidebarMenuItem
              icon={Layers2}
            ...
            <SidebarMenuItem
              icon={Layers2}
              text="Linear rich-text editor"
              href="/storybook/linear-editor"
            />
            <SidebarMenuItem
              icon={Layers2}
              text="Linear insights & charts"
              href="/storybook/linear-insights"
            />
            <SidebarMenuItem
              icon={Layers2}
