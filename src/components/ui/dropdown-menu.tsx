...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "bg-surface-overlay [color:var(--content-primary)] z-50 min-w-[8rem] overflow-hidden rounded-[var(--radius-menu)] border border-border-default p-1 shadow-[var(--shadow-menu)]",
        "origin-[var(--radix-dropdown-menu-content-transform-origin)] data-[state=open]:animate-[orbit-pop-in_var(--motion-fast)_var(--ease-out)_both] data-[state=closed]:animate-[orbit-pop-out_var(--motion-fast)_var(--ease-out)_both] motion-reduce:animate-none",
        className
      )}
      {...props}
    />
